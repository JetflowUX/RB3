...
export function Stylists() {
  return (
    <section id="stylists" className="py-20 sm:py-24 md:py-32 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 sm:mb-24 gap-8">
          <div className="max-w-2xl">
            ...
            <h3 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold leading-none">
          ...
          {stylists.map((stylist, index) => (
            ...
            >
              ...
              <div className="w-full h-full overflow-hidden relative bg-purple-surface">
                ...
                {/* Vertical Role */}
                <div className="absolute top-6 right-3 sm:top-8 sm:right-4 vertical-rl rotate-180 text-[9px] sm:text-[10px] tracking-[0.3em] text-gold uppercase">
                  {stylist.specialty}
                </div>

                {/* Content Bottom */}
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 md:p-8 transform translate-y-0 md:translate-y-8 md:group-hover:translate-y-0 transition-transform duration-500">
                  <h4 className="text-2xl sm:text-3xl font-serif font-bold text-white mb-4 sm:mb-6">
                    {stylist.name}
                  </h4>
