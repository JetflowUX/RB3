...
export function Gallery() {
  return (
    <section
      id="gallery"
      className="py-20 sm:py-24 md:py-32 relative z-10 bg-purple-surface/20 border-y border-gold/5"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-start justify-between mb-14 sm:mb-20 gap-8">
          <div>
            ...
            <h3 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold">
              Our Masterpieces
            </h3>
          </div>
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 sm:gap-6 space-y-4 sm:space-y-6">
          {images.map((img, index) => (
            ...
            >
              ...
              {/* Editorial Caption */}
              <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 transform translate-y-0 md:translate-y-4 opacity-100 md:opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-500">
